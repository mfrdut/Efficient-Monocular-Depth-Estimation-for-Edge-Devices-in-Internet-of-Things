...
python tune_run.py 
```
For example, on the device Jetson Nano, we obtained the runtime of the optimized models and three files: deploy_graph.json, deploy_lib.tar, and deploy_param.params. The image "Nano_GPU_results.jpg" displays our runtime on Nano GPU as follows:
...
The image "UP Board_CPU_results.png" displays our runtime on UP Board CPU. 
...
The results on different hardware architectures are listed in our papers.
#### Citation
